package lenovo.example.com.taobao_gouwuche_zz.adapter;
...
import lenovo.example.com.taobao_gouwuche_zz.R;
...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (child != null) {
            ...
            childViewHolder.goods_size.setText("商品:" + child.getColor() + ",类型:" + child.getSize());
            //设置打折前的原价
